...
parser.add_argument('-d', type=int, default=False, help="developer mode (1,0)")
parser.add_argument('-ledCount', type=int, default=337, help="the number of leds this device controls (integer)")
