...
def chasing():
    ...
    for x in range(0,strip.numPixels(), 1):
        ...
        for i in range(x,endPixel):
            strip.setPixelColor(i % strip.numPixels(), Color(255,0,255))
            #Serial.println("setting pixel colors for 50");

        #green
        for i in (x+(strip.numPixels()/2),endPixel+(strip.numPixels()/2)):
            strip.setPixelColor(i % strip.numPixels(), Color(100,255,0))
            #Serial.println("setting pixel colors for 50");
        ...
        #clear green
        for i in range(1,5):
            strip.setPixelColor((x+(strip.numPixels()/2) - i) % strip.numPixels(), Color(0,0,0))
